        ...
        <div class="lg:col-span-5 bg-[#112250] p-8 lg:p-12 flex flex-col justify-between relative overflow-hidden text-[#F5F0E9]">
          ...
          <div class="relative z-10 my-auto py-6">
            ...
            <p class="mt-4 text-[#D9CBC2] text-sm leading-relaxed">
              Sign in to access your account, review recent updates, and keep
              managing your workspace seamlessly.
            </p>
          </div>
          ...
          <div class="max-w-md mx-auto w-full">
            ...
            >
              ...
              <div>
                <label
                  for="customer_email"
                  class="block text-xs font-bold text-[#3C5070] uppercase tracking-wider mb-1.5"
                >
                  Email Address
                </label>
              ...
              <div>
                <div class="flex items-center justify-between mb-1.5">
                  <label
                    ...
                    class="block text-xs font-bold text-[#3C5070] uppercase tracking-wider"
                  >
                    Password
                  </label>
                  ...
                  <.link
                    ...
                    class="text-xs font-semibold text-[#3C5070] hover:text-[#112250] hover:underline transition"
                  >
                    Forgot password?
                  </.link>
                </div>
